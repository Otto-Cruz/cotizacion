        ...
        <div class="container">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h4><i class='glyphicon glyphicon-edit'></i> Nueva Cotizaci&oacute;n</h4>
                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control input-sm" id="id_vendedor">
                                    <?php
                                    $sql_vendedor = mysqli_query($con, "select * from tb_usuarios order by apellidos");
                                    while ($rw = mysqli_fetch_array($sql_vendedor)) {
                                        $id_vendedor = $rw["id_usuario"];
                                        $nombre_vendedor = $rw["nombres"] . " " . $rw["apellidos"];
