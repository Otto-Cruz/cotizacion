			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="warning">
					...
					<th><span class="pull-right">Dscto.</span></th>
				...
				while ($row=mysqli_fetch_array($query)){
					...
					$precio_producto=$row["precio_producto"];
                                                                                        $dscto_producto=$row["porcentaje_dscto_base"];
                                                                                        $precio_producto_con_dscto=$precio_producto*(1-$dscto_producto/100);
					$precio_venta=number_format($precio_producto_con_dscto,2);
					?>
					<tr>
						...
						<input type="text" class="form-control" style="text-align:right" id="dscto_producto_<?php echo $id_producto; ?>"  value="<?php echo $dscto_producto." %";?>" >
						</div></td>
                                                <td class='col-xs-2'><div class="pull-right">
