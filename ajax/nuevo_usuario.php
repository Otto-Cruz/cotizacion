    ...
    require_once("../libraries/password_compatibility_library.php");
		...
		if (empty($_POST['firstname'])){
			...
			require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
                ...
                $sql = "SELECT * FROM tb_usuarios WHERE cuenta_usuario = '" . $user_name . "' OR email_usuario = '" . $user_email . "';";
                ...
                if ($query_check_user == 1) {
                    ...
                    $sql = "INSERT INTO tb_usuarios (nombres, apellidos, cuenta_usuario, password_usuario, email_usuario, fecha_creacion)
