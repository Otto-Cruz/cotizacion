...
if (empty($_POST['mod_id'])) {
    ...
    $id_unidad_de_medida = intval($_POST['mod_id']);
    $sql = "UPDATE tb_unidad_de_medida SET nombre_unidad='" . $nombre . "',descripcion_unidad='" . $descripcion ."' WHERE id_unidad_medida='".$id_unidad_de_medida. "'";
    $query_update = mysqli_query($con, $sql);
    if ($query_update) {
        $messages[] = "Unidad de Media ha sido actualizado satisfactoriamente.";
    } else {
